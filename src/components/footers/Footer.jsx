...
import { FaLinkedin, FaTwitter, FaInstagram, FaFacebook, FaDribbble } from "react-icons/fa";
...
const Footer = () => {
  ...
  const contentVariants = {
    ...
    visible: {
      ...
      x: 0,
      scale: 1,
      transition: { type: "spring", stiffness: 120, damping: 16, mass: 0.9, delay: 0.2 },
    },
  };
  ...
  const socialIconVariants = {
    ...
    visible: (index) => ({
      opacity: 1,
      scale: 1,
      transition: { type: "spring", stiffness: 200, damping: 15, delay: 0.6 + index * 0.1 },
    }),
  };
  ...
  const socialIcons = [
    ...
    { icon: FaDribbble, label: "Behance" },
  ];

  return (
    <div ref={sectionRef} className="relative bg-black text-white py-20 px-6 md:px-40 overflow-hidden">
              ...
              <ul className="space-y-2 text-zinc-300 text-sm">
                {["Process", "Services", "Benefits", "Plans", "Contact"].map((item, index) => (
                  <motion.li
                    ...
                    animate={{ opacity: 1, x: 0, transition: { delay: 0.8 + index * 0.1, type: "spring", stiffness: 200, damping: 20 } }}
                    whileHover={{ x: 5, color: "#ffffff", transition: { type: "spring", stiffness: 300, damping: 20 } }}
                  >
                    {item}
                  </motion.li>
                ))}
