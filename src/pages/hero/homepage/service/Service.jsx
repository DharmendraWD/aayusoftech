...
import servImg1 from "../../../../../public/img/services/Webdevelopment.gif"
import servImg2 from "../../../../../public/img/services/socialmedia.png"
import servImg3 from "../../../../../public/img/services/mobileapp.gif"
import servImg4 from "../../../../../public/img/services/Webdesign.png"
import servImg5 from "../../../../../public/img/services/Itconsulting.png"
...
const Media = ({ src, alt }) => (
  <div className="relative w-full h-[260px] md:h-[250px] rounded-lg overflow-hidden mb-6 bg-black">
    <Image
      ...
      unoptimized={String(src).endsWith(".gif") || String(src).includes(".gif")}
